...
fun toolchainForMpsVersion(mpsVersion: String): Action<JavaToolchainSpec> =
...
fun configureJavaForMpsVersion(javaExec: JavaExec, mpsHome: File, mpsVersion: String) {
    val toolchainAction = toolchainForMpsVersion(mpsVersion)
    val launcher = serviceOf<JavaToolchainService>().launcherFor(toolchainAction)
